...
var controlsContent = [{
  ...
  content: {
    default: {
      title: 'Essential',
      description: "Enables the core functionality on our websites, such as navigation, access to secure areas, video players and payments. Our websites cannot function properly without these cookies; they can only be disabled by changing your browser preferences.",
  ...
  content: {
    default: {
      title: 'Performance',
      description: 'Collects information on usage on our websites, for example, which pages are most frequently visited.'
    },
    zh: {
      title: '表现性',
  ...
  content: {
    default: {
      title: 'Functional',
      description: 'Recognizes you when you return to our websites. This enables us to personalize content, greet you by name, remember your preferences, and helps you share pages on social networks.'
    },
    zh: {
      title: '功能性',
...
var content = {
  default: {
    notification: {
      ...
      body1: 'We use cookies and similar methods to recognize visitors and remember preferences. We also use them to measure campaign effectiveness and analyze traffic on our websites. By selecting ‘Accept‘, you consent to the use of these methods by us and trusted third parties. For further details or to change your consent choices at any time see our <a href="https://canonical.com/legal/data-privacy?cp=hide#cookies">cookie policy</a>.',
      buttonManage: 'Manage your tracker settings',
      buttonAcceptAll: 'Accept all'
    },
    manager: {
      title: 'Tracking choices',
      body1: 'We use cookies to recognize visitors and remember your preferences. They enhance user experience, personalize content and ads, provide social media features, measure campaign effectiveness, and analyze traffic on our websites.',
  ...
  zh: {
    notification: {
      title: '您的追踪器设置',
      body1: '我们使用 cookie 和相似的方法来识别访问者和记住访问者的偏好设置，并用来衡量活动的效果和分析 Canonical 旗下所有网站的流量。选择”接受“，您同意我们和受信的第三方来使用这些资料。更多细节或者随时变更您的选择，请阅读我们的<a href="https://canonical.com/legal/data-privacy?cp=hide#cookies"> cookie 策略</a>。',
...
var getCookie = function getCookie(targetCookie) {
...
var preferenceNotSelected = function preferenceNotSelected() {
  var cookieValue = getCookie("_cookies_accepted=");
...
function postUpdatedPreferences() {
  ...
  var cookieServiceUp = getCookie("_cookies_service_up=");
  if (!cookieServiceUp || cookieServiceUp !== "1") {
    return;
  }
  // Check if preferences cookie exists
  var cookieAcceptanceValue = getCookie("_cookies_accepted=");
  ...
  fetch("/cookies/set-preferences", {
    ...
    body: JSON.stringify({
      "preferences": {
        "consent": cookieAcceptanceValue
      }
    })
  }).catch(function (err) {
    return console.error("Error sending preferences:", err);
  });
}
...
var Notification = /*#__PURE__*/function () {
  ...
  return _createClass(Notification, [{
    ...
    value: function initaliseListeners() {
      var _this = this;
      this.container.querySelector(".js-close-all").addEventListener("click", function () {
        handleClose("all", _this.destroyComponent)();
  ...
  return _createClass(Manager, [{
    ...
    value: function initaliseListeners() {
      ...
      this.container.querySelector(".js-close").addEventListener("click", function () {
        handleClose("all", _this2.destroyComponent)();
        postUpdatedPreferences();
      });
